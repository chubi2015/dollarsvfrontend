        ...
        <Page size="A4" style={styles.page}>
          <View style={styles.invoiceFirst}>
            <View>
              ...
              <Text style={styles.info}>
                ...
                {data.status === 'Entrega Programada' && (
                  <span style={{ color: '#14b8a6' }}>{data.status}</span>
                )}
                {data.status === 'En Ruta' && (
                  <span style={{ color: '#0E34DE' }}>{data.status}</span>
                )}
          ...
          <View style={styles.invoiceThird}>
            ...
            <View>
              ...
              <Text style={styles.info}> ${roundNumber(data.discount)}</Text>
            </View>

            <View>
              <Text style={styles.title}>Total Amount</Text>
              <Text style={styles.amount}>${roundNumber(data.total)}</Text>
            </View>
          </View>
