...
const ProductCard = ({ product, admin, setProducto, handleClickUpdate }) => {
      ...
      <div className="group box-border overflow-hidden flex rounded-md shadow-sm pe-0 flex-col items-center bg-white relative">
        ...
        <div className="w-full px-3 lg:px-4 pb-4 overflow-hidden">
          <div className="relative mb-1">
            ...
            {admin?<p style={{fontSize: "10px"}}>{product.title}</p>:<h2 className="text-heading truncate mb-0 block text-sm font-medium text-gray-600">
          ...
          <div className="flex justify-between items-center text-heading text-sm sm:text-base space-s-2 md:text-base lg:text-xl">
            ...
            ):<p style={{fontWeight: "bold", fontSize: "10px"}}>{"Qty: "+product.quantity}</p>}
          </div>
        </div>
      </div>
    </>
