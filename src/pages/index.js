                ...
                <div className="mb-10 flex justify-center">
                  <div className="text-center w-full lg:w-2/5">
                    ...
                    <p className="text-base font-sans text-gray-600 leading-6">
                      Escoge tus productos de las siguientes categorias
                    </p>
                  </div>
                </div>
                <FeatureCategory />
            ...
            <div className="bg-gray-50 lg:py-16 py-10 mx-auto max-w-screen-2xl px-3 sm:px-10">
              <div className="mb-10 flex justify-center">
                <div className="text-center w-full lg:w-2/5">
                  ...
                  <p className="text-base font-sans text-gray-600 leading-6">
                    Mira todos nuestros productos populares de esta semana, presiona sobre el icono
                    de la canasta en la esquina inferior derecha de cada producto para agregarlo al carrito.
                  </p>
                </div>
              </div>
              <div className="flex">
